...
pub(crate) fn get_hashed_password(password: &str) -> String {
...
pub(crate) fn get_jwt_for_user(user: &models::User) -> String {
...
pub(crate) fn with_auth(role: Role ) -> impl Filter<Extract = (String,), Error = Rejection> + Clone {
    headers_cloned()
